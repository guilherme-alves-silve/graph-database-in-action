...
public class App {
    ...
    private static void addRestaurant(GraphTraversalSource g, String restaurantId, String restaurantName, String cuisineName) {
        var faker = new Faker();
        ...
        Vertex r = (Vertex) g.V().
          has("restaurant","restaurant_id", Integer.parseInt(restaurantId)).fold().
          coalesce(
              unfold(),
              addV("restaurant").
                  property(single, "restaurant_id", Integer.parseInt(restaurantId)).
                  property(single, "name", restaurantName).
        ...
        Vertex c = g.V().
          has("cuisine", "name", cuisineName).fold().
          coalesce(
              unfold(),
              addV("cuisine").property(single, "name", cuisineName)
            ).
          next();
